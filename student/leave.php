<?php
  ...
  $query="insert into leave_application(id,admno,l_type,reason,start,end) values('$uid','$a','$g','$h','$i','$j')";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Leave Application</h4><br>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" id="l_type" name="l_type">
