            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-subtitle">Displaying all the payment details from students.</h6>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-hover table-bordered no-wrap">
                                        ...
                                        <td><a href="payreciptview.php?admno=<?php echo $row->admno;?>&date=<?php echo $row->date;?>">view</a></td>
                                        <td>
