<?php
    ...
    $query="INSERT into warden(name,email,Contact_no,password) values(?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('ssss',$fname,$emailid,$contactno,$password);
    $stmt->execute();
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Warden Registration Form</h4>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Contact Number</h4>
                    <div class="form-group">
                        <input type="text" name="contact" id="contact"  pattern="[789][0-9]{9}" placeholder="Your Contact" required="required" class="form-control">
                    </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Password</h4>
                    <div class="form-group">
                        <input type="password" name="password" id="password"  minlength="8" placeholder="Enter Password" required="required" class="form-control">
                    </div>
            </div>
        </div>
    </div>
