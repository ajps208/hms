<?php
    ...
    if(isset($_POST['update'])){
        ...
        $query="UPDATE payment SET status='$z' WHERE admno=$x AND date='$y'";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php	
                 $id=$_GET["admno"];
                 $date=$_GET["date"];
                 $ret = "SELECT  l.admno, u.name,u.email, r.bedno, r.roomno, l.amount,l.recipt, l.date, l.status
                 FROM payment l
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                        <input type="text" name="d" id="d" value="<?php echo $date; ?>" class="form-control" readonly>
                                    </div>
                            </div>
                        </div>
                    </div>
