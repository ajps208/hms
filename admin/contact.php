                            ...
                            <div class="card-body">
                                <h4 class="card-title">Email</h4>
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" name="mail" id="mail" onChange="getSeater(this.value);"  required id="inlineFormCustomSelect">
                                            <option selected>Select...</option>
                                            <?php $query = "SELECT email FROM userregistration";
