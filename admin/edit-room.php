<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $type=$_POST['rtype'];
        $id=$_GET['id'];
        $query="UPDATE rooms set bed_no=?,room_type=? where id=?";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('iii',$bed,$type,$id);
        $stmt->execute();
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                            <input type="text" name="bed_no" value="<?php echo $row->bed_no;?>" id="bed_no" class="form-control" >
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Room Type</h4>
                                        <div class="form-group">
                                            <input type="text" name="rtype" id="rtype" value="<?php echo $row->room_type;?>" class="form-control">
                                        </div>
                                </div>
                            </div>
                        </div>
