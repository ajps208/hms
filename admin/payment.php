<?php
        ...
        foreach($a as $index => $ae)
    {
        ...
        $query="INSERT into  payment(admno,amount,date) values('$aa','$ee','$qq')";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Payment Calculation </h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-hover table-bordered no-wrap">
                                        ...
                                        <td ><input type="text" name="aid[]"  style="width:80px; background: transparent; border: none;" value="<?php echo $row->admno;?>" readonly></td>
